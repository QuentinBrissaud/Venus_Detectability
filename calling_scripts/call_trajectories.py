...
if __name__ == '__main__':
    ...
    folder_probas = '/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/final_probas/'
    ...
    all_type_sensors = [
        #('same_event', dict(one_balloon='/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/surface_ratios/surface_ratios_one_balloon_{}_active.csv')),
        ('any_event', dict(network='/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/surface_ratios/surface_ratios_network_balloon_20.0_50.0_any_event_{}_active.csv',)),
        #('same_event', dict(network='/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/surface_ratios/surface_ratios_network_balloon_20.0_50.0_same_event_{}_active.csv',))
    ]

    def create_proba_name(name_sensor, type_detection, scenario, noise_level, alt_balloon, period, subsurface_model):
        return f'final_probas_{name_sensor}_{type_detection}_{scenario}_n{noise_level}_alt{alt_balloon:.0f}_{1./period:.0f}s_{subsurface_model}_15.11.2025.csv'
    
    for type_detection, type_sensors in all_type_sensors: 
                ...
                for name_sensor, pattern in type_sensors.items():
                    for scenario in scenarios:
                        ...
                        for period in shape_new.keys():
                            file_proba = f'{folder_probas}{create_proba_name(name_sensor, type_detection, scenario, noise_level, alt_balloon, period, subsurface_model)}'
                ...
                for name_sensor, pattern in type_sensors.items():
                    ...
                    for scenario in scenarios:
                        ...
                        for period in shape_new.keys():
                            ...
                            #file_proba = f'{folder_probas}final_probas_{name_sensor}_{type_detection}_{scenario}_n{noise_level}_alt{alt_balloon:.0f}_{1./period:.0f}s_{subsurface_model}_24.10.2025.csv'
                            file_proba = f'{folder_probas}{create_proba_name(name_sensor, type_detection, scenario, noise_level, alt_balloon, period, subsurface_model)}'
                            ...
                            proba_model = pm.proba_model_CPUs(pd_slopes, surface_ratios[name_sensor], amplitude_model, apply_fc_correction=apply_fc_correction, which_TL_distribution=which_TL_distribution)
                            proba_model.compute_scores_across_CPUs(**opt_model)
