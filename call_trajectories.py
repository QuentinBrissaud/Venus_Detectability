...
if __name__ == '__main__':
    ...
    subsurface_models = ['Hot25', 'Hot10']

    ## proc7
    type_detection = 'any_event'
    subsurface_models = ['Cold100', 'Hot25', 'Hot10']
    ...
    for subsurface_model in subsurface_models:
        ...
        for alt_balloon in alt_balloons: 
            ...
            for name_sensor, pattern in type_sensors.items():
                ...
                #pattern = '/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/surface_ratios/surface_ratios_one_balloon_{}_active.csv'
                ...
                for scenario in scenarios:
                    ...
                    for period in TL_new.keys():
                        ...
                        file_proba = f'/staff/quentin/Documents/Projects/2024_Venus_Detectability/data/final_probas/final_probas_{name_sensor}_{type_detection}_{scenario}_n{noise_level}_alt{alt_balloon:.0f}_{1./period:.0f}s_{subsurface_model}_newwinds.csv'
